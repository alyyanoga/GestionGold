...
$sql = "SELECT * FROM temptransactionor WHERE Rgmt = '$rgmt'";
...
$pdf->SetX(10);
$pdf->Cell(45,6,txt("Facture-".$type_operation." N°"),0,0);
$pdf->Cell(20,6,$rgmt,0,0);
$pdf->Ln(8);
$pdf->SetX(110);
$pdf->Ln(2);
$pdf->SetX(10);
$pdf->Cell(40,6,"Nom Client :",0,0);
$pdf->Cell(80,6,$nom_client,0,2);
$pdf->Ln(2);
$pdf->SetX(10);
$pdf->Cell(40,6,"Nom Rep. Client :",0,0);
$pdf->Cell(80,6,$rep_client,0,1);
$pdf->Ln(2);
$pdf->SetX(10);
...
$pdf->Cell(25,8,'-',0,0,'C');
$pdf->Cell(40,8,formatSansArrondi($sommeMontant,0),1,1,'L');
