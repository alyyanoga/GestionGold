...
$sql = "SELECT * FROM devise_proforma WHERE Id = '$id'";
...
$pdf->SetX(160);
$pdf->Cell(0,3,number_format($data['Montant_depot'],0,' ',' ') . ' FCFA',0,1);
$pdf->SetFont('Arial','B',11);
$pdf->Cell(20,10,'En lettre : ',0,0);
$pdf->Cell(100,10,convertir_en_lettres($data['Montant_depot']).' francs CFA',0,1);
$pdf->SetFont('Arial','B',11);
...
$pdf->Cell(100,4,convertir_en_lettres($data['Montant_depot']).' francs CFA',0,1);
$pdf->SetFont('Arial','B',11);
