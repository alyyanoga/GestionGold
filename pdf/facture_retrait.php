...
$pdf->Cell(100,6,$data['R_client'],0,1);
$pdf->SetX(12);
$pdf->SetFont('Arial','B',12);
$pdf->Cell(180,8,"DETAILS OPERATIONS","BT",1,'C');
$pdf->SetFont('Arial','B',11);
$pdf->Cell(20,10,'Montant : ',0,0);
$pdf->Cell(10,10, number_format($data['Montant_retrait'],0,' ',' ') . ' FCFA',0,1);
$pdf->SetX(118);
$pdf->SetFont('Arial','B',11);
...
$pdf->Cell(100,25,convertir_en_lettres($data['Montant_retrait']).' francs CFA',0,1);
$pdf->SetFont('Arial','B',11);
...
$pdf->Image('../assets/Icone/or.jpg',182,137,20,20);
$pdf->SetFont('Arial','B',22);
$pdf->SetX(55);
$pdf->Cell(100,10,'DIALLO SERVICE',1,1,'C');
$pdf->SetFont('Arial','B',16);
