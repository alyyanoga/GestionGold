  ...
  function cleanNumber($value) {
   ...
   if (isset($_GET['txtIdClient']) && !empty($_GET['txtIdClient'])) {
    ...
    if (isset($_POST['btn_finale_achat'])) {
        ...
        $Prix =  cleanNumber($_POST['txt_Base']);
        $Quantite = cleanNumber($_POST['txt_Quantite']);
      
        $Montant_depot = cleanNumber($_POST['txt_Montant']);
        $Ancien_solde  = cleanNumber($_POST['txt_solde_client']);
        $Ancien_solde_caisse = cleanNumber($_POST['txt_solde_caisse']);
        $Debit = $Montant_depot;
        ...
        $Nom_R_client = $_POST['txt_Rep_Client'] ?? '';
        ...
        <div class="modalBrouillon" id="modalBrouillon">
            ...
            <div class="modal-content-brouillon"   >
                ...
                <div class="table-responsive-brouillon">
                    <table border="1" class="table-client" id="table">
                    ...
                    <div class="content-validation">
                        <div class="input-content-validation">
                             <input type="hidden" class="numero" name="txt_numero" id="txt_numero" readonly>
                              <input type="text" class="id_client" name="txt_id_client" id="txt_id_client" readonly>
                             <input type="text" class="solde_client" name="txt_solde_client" id="txt_solde_client" readonly>
                            <input type="hidden" class="solde_caisse" name="txt_solde_caisse" id="txt_solde_caisse" readonly>
                            <input type="text" class="id_op" name="txt_id_op" id="txt_id_op" readonly >
